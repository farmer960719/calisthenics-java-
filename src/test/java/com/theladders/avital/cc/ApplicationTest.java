...
public class ApplicationTest {
    ...
    public void employers_should_be_able_to_publish_a_job() throws NotSupportedJobTypeException, RequiresResumeForJReqJobException, InvalidResumeException {
        ...
        application.execute("publish",new Employer(employerName),new Job(jobName, "JReq"),new JobSeeker(null),new Resume(null), null);
    ...
    public void employers_should_only_be_able_to_see_jobs_published_by_them() throws NotSupportedJobTypeException, RequiresResumeForJReqJobException, InvalidResumeException {
        ...
        application.execute("publish",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "JReq"),new JobSeeker(null),new Resume(null), null);
        application.execute("publish",new Employer(employerTencent),new Job(juniorJavaDevJob, "JReq"),new JobSeeker(null),new Resume(null), null);
    ...
    public void employers_should_be_able_to_publish_ATS_jobs() throws NotSupportedJobTypeException, RequiresResumeForJReqJobException, InvalidResumeException {
        ...
        application.execute("publish",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "ATS"),new JobSeeker(null),new Resume(null), null);
        List<List<String>> jobs = application.getJobs(employerAlibaba, "published");
        List<List<String>> expected = new ArrayList<List<String>>() {{
    ...
    public void employers_should_not_be_able_to_publish_jobs_that_are_neither_ATS_nor_JReq() throws NotSupportedJobTypeException, RequiresResumeForJReqJobException, InvalidResumeException {
        ...
        application.execute("publish",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "RJeq"),new JobSeeker(null),new Resume(null), null);
    }
    ...
    public void jobseekers_should_be_able_to_save_jobs_published_by_employers_for_later_review() throws NotSupportedJobTypeException, RequiresResumeForJReqJobException, InvalidResumeException {
        ...
        application.execute("publish",new Employer(employerAlibaba),new Job(jobName, "JReq"),new JobSeeker(null),new Resume(null), null);
        application.execute("save",new Employer(jobSeekerName),new Job(jobName, "JReq"),new JobSeeker(null),new Resume(null), null);
    ...
    public void jobseekers_should_be_able_to_apply_for_an_ATS_job_some_employer_published_without_a_resume() throws NotSupportedJobTypeException, RequiresResumeForJReqJobException, InvalidResumeException {
        ...
        application.execute("publish",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "ATS"),new JobSeeker(null),new Resume(null), null);
        application.execute("publish",new Employer(employerAlibaba),new Job(juniorJavaDevJob, "ATS"),new JobSeeker(null),new Resume(null), null);
        application.execute("apply",new Employer(employerAlibaba),new Job(juniorJavaDevJob, "ATS"),new JobSeeker(jobSeekerName),new Resume(null), LocalDate.parse("2020-01-01"));
        application.execute("apply",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "ATS"),new JobSeeker(jobSeekerName),new Resume(null), LocalDate.parse("2020-01-01"));
    ...
    public void jobseekers_should_not_be_able_to_apply_for_an_JReq_job_some_employer_published_without_a_resume() throws NotSupportedJobTypeException, RequiresResumeForJReqJobException, InvalidResumeException {
        ...
        application.execute("publish",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "JReq"),new JobSeeker(null),new Resume(null), null);
        application.execute("apply",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "JReq"),new JobSeeker(jobSeekerName),new Resume(null), LocalDate.now());
    }
    ...
    public void jobseekers_should_not_be_able_to_apply_for_an_JReq_job_some_employer_published_with_someone_else_s_resume() throws NotSupportedJobTypeException, RequiresResumeForJReqJobException, InvalidResumeException {
        ...
        application.execute("publish",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "JReq"),new JobSeeker(null),new Resume(null), null);
        application.execute("apply",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "JReq"),new JobSeeker(jobSeekerName),new Resume(resumeApplicantName), LocalDate.now());
    }
    ...
    public void employers_should_be_able_to_find_applicants_of_a_job() throws NotSupportedJobTypeException, RequiresResumeForJReqJobException, InvalidResumeException {
        ...
        application.execute("publish",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "ATS"),new JobSeeker(null),new Resume(null), null);
        application.execute("apply",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "ATS"),new JobSeeker(jobSeekerJacky),new Resume(null), LocalDate.now());
        application.execute("apply",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "ATS"),new JobSeeker(jobSeekerLam),new Resume(null), LocalDate.now());
    ...
    public void employers_should_be_able_to_find_applicants_to_a_job_by_application_date() throws NotSupportedJobTypeException, RequiresResumeForJReqJobException, InvalidResumeException {
        ...
        application.execute("publish",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "ATS"),new JobSeeker(null),new Resume(null), null);
        application.execute("apply",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "ATS"),new JobSeeker(jobSeekerJacky),new Resume(null), LocalDate.parse("1997-07-01"));
        application.execute("apply",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "ATS"),new JobSeeker(jobSeekerHo),new Resume(null), LocalDate.parse("1999-12-20"));
    ...
    public void employers_should_be_able_to_find_applicants_to_a_job_by_job_name_and_period_when_period_start_is_given_while_period_end_is_not() throws NotSupportedJobTypeException, RequiresResumeForJReqJobException, InvalidResumeException {
        ...
        application.execute("publish",new Employer(employerAlibaba),new Job(juniorJavaDevJob, "ATS"),new JobSeeker(null),new Resume(null), null);
        application.execute("publish",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "JReq"),new JobSeeker(null),new Resume(null), null);
        application.execute("apply",new Employer(employerAlibaba),new Job(juniorJavaDevJob, "ATS"),new JobSeeker(jobSeekerJacky),new Resume(null), LocalDate.parse("1997-07-01"));
        application.execute("apply",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "JReq"),new JobSeeker(jobSeekerJacky),new Resume(resumeApplicantName), LocalDate.parse("1999-12-20"));
        application.execute("apply",new Employer(employerAlibaba),new Job(juniorJavaDevJob, "ATS"),new JobSeeker(jobSeekerHo),new Resume(null), LocalDate.parse("1999-12-20"));
    ...
    public void employers_should_be_able_to_find_applicants_to_a_job_by_job_name_and_period() throws NotSupportedJobTypeException, RequiresResumeForJReqJobException, InvalidResumeException {
        ...
        application.execute("publish",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "ATS"),new JobSeeker(null),new Resume(null), null);
        application.execute("publish",new Employer(employerAlibaba),new Job(juniorJavaDevJob, "ATS"),new JobSeeker(null),new Resume(null), null);
        application.execute("apply",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "ATS"),new JobSeeker(jobSeekerWong),new Resume(null), LocalDate.parse("1997-07-01"));
        application.execute("apply",new Employer(employerAlibaba),new Job(juniorJavaDevJob, "ATS"),new JobSeeker(jobSeekerJacky),new Resume(null), LocalDate.parse("1997-07-01"));
        application.execute("apply",new Employer(employerAlibaba),new Job(juniorJavaDevJob, "ATS"),new JobSeeker(jobSeekerHo),new Resume(null), LocalDate.parse("1998-01-01"));
    ...
    public void should_generator_csv_reports_of_all_jobseekers_on_a_given_date() throws NotSupportedJobTypeException, RequiresResumeForJReqJobException, InvalidResumeException {
        ...
        application.execute("publish",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "JReq"),new JobSeeker(null),new Resume(null), null);
        application.execute("apply",new Employer(employerAlibaba),new Job(juniorJavaDevJob, "ATS"),new JobSeeker(jobSeekerJacky),new Resume(null), LocalDate.parse("1997-07-01"));
        application.execute("apply",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "JReq"),new JobSeeker(jobSeekerJacky),new Resume(jackyResume), LocalDate.parse("1999-12-20"));
        application.execute("apply",new Employer(employerAlibaba),new Job(juniorJavaDevJob, "ATS"),new JobSeeker(jobSeekerHo),new Resume(null), LocalDate.parse("1999-12-20"));
        application.execute("apply",new Employer(employerAlibaba),new Job(juniorJavaDevJob, "ATS"),new JobSeeker(jobSeekerLam),new Resume(null), LocalDate.parse("1999-12-20"));
    ...
    public void should_be_able_to_see_successful_application_of_a_job_for_an_employer() throws NotSupportedJobTypeException, RequiresResumeForJReqJobException, InvalidResumeException {
        ...
        application.execute("publish",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "ATS"),new JobSeeker(null),new Resume(null), null);
        application.execute("publish",new Employer(employerAlibaba),new Job(juniorJavaDevJob, "ATS"),new JobSeeker(null),new Resume(null), null);
        application.execute("publish",new Employer(employerTencent),new Job(juniorJavaDevJob, "ATS"),new JobSeeker(null),new Resume(null), null);
        application.execute("apply",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "ATS"),new JobSeeker(jobSeekerJacky),new Resume(null), LocalDate.now());
        application.execute("apply",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "ATS"),new JobSeeker(jobSeekerLam),new Resume(null), LocalDate.now());
    ...
    public void should_be_able_to_see_unsuccessful_applications_of_a_job_for_an_employer() throws NotSupportedJobTypeException, RequiresResumeForJReqJobException, InvalidResumeException {
        ...
        application.execute("publish",new Employer(employerAlibaba),new Job(juniorJavaDevJob, "ATS"),new JobSeeker(null),new Resume(null), null);
        try {
            application.execute("apply",new Employer(employerAlibaba),new Job(seniorJavaDevJob, "JReq"),new JobSeeker(jobSeekerJacky),new Resume(null), LocalDate.now());
        } catch (RequiresResumeForJReqJobException ignored) {}
        application.execute("apply",new Employer(employerAlibaba),new Job(juniorJavaDevJob, "ATS"),new JobSeeker(jobSeekerLam),new Resume(null), LocalDate.now());
